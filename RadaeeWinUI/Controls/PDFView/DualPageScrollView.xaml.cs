...
{
    public sealed partial class DualPageScrollView : PDFView
    {
        ...
        public override float ToPDFY(float screenY, int pageIndex)
        {
            ...
            float pdfY = pageHeight - (relativeY / scale);
            return pdfY;
        }
        ...
        protected override void OnSizeChanged(object sender, SizeChangedEventArgs e)
        {
            if (e.NewSize.Width > 0 && e.NewSize.Height > 0)
            {
                ...
                if (Math.Abs(currentViewportWidth - _lastViewportWidth) > 1.0)
                {
